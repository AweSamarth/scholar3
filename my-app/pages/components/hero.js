...
export default function Hero() {
  ...
  return (
    <div className="hero flex flex-col flex-wrap padding-[1rem] w-[100%] min-h-[100vh]  px-12 bg-[url('../public/Background.png')]  ">
      ...
      <div className=" absolute right-7 top-4"><ConnectButton /></div>
      ...
      <div className=" border-red-500 flex justify-evenly mt-4">
       {address?( <div className=" border-blue-500 flex">
          <button className="research font-Michroma self-center transition-all hover:bg-[#16161f]" >Research</button>
        </div>): (<div className=" border-blue-500 flex">
          <button className="research font-Michroma self-center transition-all hover:bg-[#16161f] " onClick={()=>openResearch()}>Research</button>
        </div>  )
}   
        ...
        <div className="border-blue-500  flex">
          <button className="library font-Michroma self-center transition-all hover:bg-[#f3f3f3] ">Library</button>
        </div>
      </div>
    </div>
  );
