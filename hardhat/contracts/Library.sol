...
contract Library {
    ...
    function viewAuthor(address theAddress)
        public
        view
    ...
    function viewAuthorBooks(address theAddress)
        public
        view
    ...
    function buyBook(string memory theCid, uint256 cost)
        public
        payable
        returns (string memory cidLelo)
    {
